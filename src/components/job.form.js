...
class JobForm extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      city: '',
      photo: '',
      formErrors: { profile: '', designation: '', salary: '', city: '', photo: '' },
      profileValid: false,
  ...
  validateForm() {
    this.setState({
      addJobValid: this.state.profileValid && this.state.designationValid && this.state.salaryValid && this.state.cityValid && this.state.photoValid
    });
  }
