...
class ManageUser extends React.Component {
  ...
  showUserDetails = (event) => {
    ...
    const oneUser = allUser.filter((item) => {
      if (item._id === id) {
        return true;
      }
      return false;
                          ...
                          <div className="btn-group">
                            ...
                            <ul className="dropdown-menu">
                              ...
                              <li>
                                ...
                                >
                                  <i className="fa fa-trash-o fa-fw"></i> Delete
                                </button>
                              </li>
                              <li>
                                <button
                ...
                <div className="row">
                  <div className="col-md-4 col-lg-4">
                    {this.state.clickedUser &&
                      !this.state.clickedUser[0].image &&
                      this.state.clickedUser[0].gender === 'Male' && (
                        <img
                    ...
                    {this.state.clickedUser &&
                      !this.state.clickedUser[0].image &&
                      this.state.clickedUser[0].gender === 'Female' && (
                        <img
                          className="img-circle"
                          src={female}
                          alt="Upload Pic"
                      ...
                      this.state.clickedUser[0].image && (
                        <img
                          ...
                          src={`${config.firebase_url +
                            this.state.clickedUser[0].image}?alt=media&${
                  ...
                  <div className="col-md-8 col-lg-8">
                    {this.state.clickedUser && (
                      <strong>{this.state.clickedUser[0].name} </strong>
                    )}
                    <br />
                    {this.state.clickedUser && (
                      <div>
          ...
          <div className="w3-modal-content w3-card-4">
            <header className="w3-container w3-teal">
              <span
                ...
                role="button"
                tabIndex={0}
                onClick={this.closeEditUserDetail}
                className="w3-button w3-large w3-display-topright"
              >
                &times;
              </span>
                      ...
                      >
                        ...
                        <div className="col-sm-10">
                          ...
                          {this.errorClass(this.state.formErrors.Password) && (
                            <span className="formErrors">
                              Password is too short and must be of length 8 and
                              must conatain a lowercase an uppercase a number
