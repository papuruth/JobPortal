...
const routes = [
  ...
  <PrivateRoute key="ChatComponent" restricted={false} path="/chat" component={ChatContainer} exact />,
  <PrivateRoute key="ProfileComponent" restricted={false} path="/profile" component={Profile} exact />,
  ...
  <PrivateRoute key="AppliedListComponent" restricted={false} path="/appliedlist" component={AppliedList} exact />,
  <PrivateRoute key="FeedbackComponent" restricted={false} path="/feedback" component={Feedback} exact />,
