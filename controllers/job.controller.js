...
import apply from '../models/appliedJobs';
import MailsDetails from '../models/mailsDetails';
import status from '../enum/jobeStatus';
import { appliedStatusComp, appliedStatusUser } from '../enum/appliedStatus';

export default class JobController {
  static validateJobs = async (req, res) => {
    try {
  ...
  static postJobs = async function postJobs(req, res) {
    try {
      const { designation, company } = req.body;
  ...
  static getJobs = async function getJobs(req, res, next) {
  ...
  static getOneJobs = async function getOneJobs(req, res) {
  ...
  static updateJobs = function updateJobs(req, res, next) {
  ...
  static deleteJobs = function deleteJobs(req, res) {
  ...
  static applyJobs = async function applyJobs(req, res) {
    try {
  ...
  static getAppliedJobs = async function getAppliedJobs(req, res) {
    try {
  ...
  static updateJobStatus = async function updateJobStatus(req, res, next) {
  ...
  static mailDetails = async function mailDetails(req, res) {
    const {
      jobId,
      name,
      company,
  ...
  static getMailDetails = async function getMailDetails(req, res, next) {
  ...
  static updateAppliedJobs = async function updateAppliedJobs(req, data, next) {
