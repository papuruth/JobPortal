...
export default class UserController {
  ...
  static getUsers = function getUsers(req, res, next) {
  ...
  static getOneUser = async function getOneUser(req, res) {
  ...
  static updateUser = async function updateUser(req, res, next) {
  ...
  static deleteUser = function deleteUser(req, res, next) {
